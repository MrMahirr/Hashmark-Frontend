  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
      ...
      <div className="bg-hm-surface rounded-card p-4 border-[0.5px] border-hm-border relative overflow-hidden">
        <div className="font-sans text-[11px] font-medium text-hm-text-secondary mb-1">Toplam Borç</div>
      ...
      {/* Added Card */}
      <div className="bg-hm-surface rounded-card p-4 border-[0.5px] border-hm-border relative overflow-hidden">
        <div className="font-sans text-[11px] font-medium text-hm-text-secondary mb-1">Eklenen (Son 7 Gün)</div>
      ...
      {/* Resolved Card */}
      <div className="bg-hm-surface rounded-card p-4 border-[0.5px] border-hm-border relative overflow-hidden">
        <div className="font-sans text-[11px] font-medium text-hm-text-secondary mb-1">Çözülen (Son 7 Gün)</div>
